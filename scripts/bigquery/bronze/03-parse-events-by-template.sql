...
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_amulet` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
-- Locked Amulet
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_locked_amulet` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
-- Validator License
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_validator_license` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
-- Validator Right
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_validator_right` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
-- App Reward Coupon
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_app_reward_coupon` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
-- SV Reward Coupon
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_sv_reward_coupon` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_validator_reward_coupon` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
-- Member Traffic
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_member_traffic` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
-- Featured App Right
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_featured_app_right` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
-- ANS Entry
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_ans_entry` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
-- Open Mining Round
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_open_mining_round` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
-- Closed Mining Round
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_closed_mining_round` AS
SELECT
  event_id,
  update_id,
  contract_id,
