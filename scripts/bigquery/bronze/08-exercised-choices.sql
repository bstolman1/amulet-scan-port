...
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.parsed_exercised_events` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.choice_frequency` AS
SELECT
  choice,
  template_id,
  consuming,
...
-- DSO Rules Choices
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.dso_rules_choices` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.amulet_rules_choices` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
-- Transfer Operations
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.transfer_operations` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.mining_round_choices` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.vote_request_choices` AS
SELECT
  event_id,
  update_id,
  contract_id,
...
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.daily_choice_activity` AS
SELECT
...
-- Interface Exercises
CREATE OR REPLACE VIEW `${PROJECT_ID}.transformed.interface_exercises` AS
SELECT
  event_id,
  update_id,
  contract_id,
