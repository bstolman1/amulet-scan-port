...
-- Validator Licenses
CREATE OR REPLACE TABLE `${PROJECT_ID}.canton_silver.validator_licenses`
...
-- Validator Rights
CREATE OR REPLACE TABLE `${PROJECT_ID}.canton_silver.validator_rights`
PARTITION BY DATE(effective_at)
...
-- Validator Faucet Coupons
CREATE OR REPLACE TABLE `${PROJECT_ID}.canton_silver.validator_faucet_coupons`
PARTITION BY DATE(effective_at)
...
-- Validator Liveness Records
CREATE OR REPLACE TABLE `${PROJECT_ID}.canton_silver.validator_liveness`
PARTITION BY DATE(effective_at)
CLUSTER BY validator_party, round_number
AS
SELECT
...
-- Validator Lifecycle
CREATE OR REPLACE TABLE `${PROJECT_ID}.canton_silver.validator_lifecycle`
...
CREATE OR REPLACE TABLE `${PROJECT_ID}.canton_silver.validator_performance`
...
FROM `${PROJECT_ID}.canton_silver.validator_lifecycle` vl;
