...
const ExternalPartyRules = () => {
  ...
  const rules = templates?.["Splice:ExternalPartyAmuletRules:ExternalPartyAmuletRules"] || [];
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">External Party Rules</h1>
          <p className="text-muted-foreground">
            External party Amulet rules contracts
          </p>
        </div>
